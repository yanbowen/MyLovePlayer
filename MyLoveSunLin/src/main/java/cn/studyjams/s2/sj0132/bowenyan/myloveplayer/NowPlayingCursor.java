package cn.studyjams.s2.sj0132.bowenyan.myloveplayer;
...
public class NowPlayingCursor extends AbstractCursor {
    ...
    public NowPlayingCursor(IMyLovePlayerService service, String[] projection, Context c) {
    ...
    private final IMyLovePlayerService mService;
}