...
public class BottomActionBarFragment extends Fragment {
    ...
    private cn.studyjams.s2.sj0132.bowenyan.myloveplayer.ui.widgets.BottomActionBar mBottomActionBar;
    
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    	View root = inflater.inflate(R.layout.bottom_action_bar, container);
        mBottomActionBar = new cn.studyjams.s2.sj0132.bowenyan.myloveplayer.ui.widgets.BottomActionBar(getActivity());
