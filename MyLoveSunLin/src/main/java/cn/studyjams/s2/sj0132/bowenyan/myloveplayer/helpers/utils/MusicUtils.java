...
package cn.studyjams.s2.sj0132.bowenyan.myloveplayer.helpers.utils;
...
import cn.studyjams.s2.sj0132.bowenyan.myloveplayer.service.ServiceBinder;
...
public class MusicUtils {
    ...
    public static IMyLovePlayerService mService = null;
    ...
    public static void setFavoriteImage(ImageButton mImageButton) {
        try {
            if (MusicUtils.mService.isFavorite(MusicUtils.mService.getAudioId())) {
                mImageButton.setImageResource(R.mipmap.apollo_holo_light_favorite_selected);
            } else {
                mImageButton.setImageResource(R.mipmap.apollo_holo_light_favorite_normal);
                // Theme chooser
