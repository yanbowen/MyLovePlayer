...
package cn.studyjams.s2.sj0132.bowenyan.myloveplayer.ui.fragments;
...
import cn.studyjams.s2.sj0132.bowenyan.myloveplayer.activities.TracksBrowser;
...
import cn.studyjams.s2.sj0132.bowenyan.myloveplayer.ui.widgets.RepeatingImageButton;
import cn.studyjams.s2.sj0132.bowenyan.myloveplayer.ui.widgets.VisualizerView;
        ...
        try {
            switch (MusicUtils.mService.getRepeatMode()) {
                case ApolloService.REPEAT_ALL:
                    mRepeat.setImageResource(R.mipmap.apollo_holo_light_repeat_all);
                    break;
                case ApolloService.REPEAT_CURRENT:
                    mRepeat.setImageResource(R.mipmap.apollo_holo_light_repeat_one);
                    break;
                default:
                    mRepeat.setImageResource(R.mipmap.apollo_holo_light_repeat_normal);
                    // Theme chooser
        ...
        try {
            switch (MusicUtils.mService.getShuffleMode()) {
                case ApolloService.SHUFFLE_NONE:
                    mShuffle.setImageResource(R.mipmap.apollo_holo_light_shuffle_normal);
                    // Theme chooser
                    ThemeUtils.setImageButton(getActivity(), mShuffle, "apollo_shuffle_normal");
                    break;
                case ApolloService.SHUFFLE_AUTO:
                    mShuffle.setImageResource(R.mipmap.apollo_holo_light_shuffle_on);
                    break;
                default:
                    mShuffle.setImageResource(R.mipmap.apollo_holo_light_shuffle_on);
                    break;
    ...
    private void setPauseButtonImage() {
        try {
            if (MusicUtils.mService != null && MusicUtils.mService.isPlaying()) {
                mPlay.setImageResource(R.mipmap.apollo_holo_light_pause);
                // Theme chooser
                ThemeUtils.setImageButton(getActivity(), mPlay, "apollo_pause");
            } else {
                mPlay.setImageResource(R.mipmap.apollo_holo_light_play);
                // Theme chooser
