...
package cn.studyjams.s2.sj0132.bowenyan.myloveplayer.app.widgets;
...
import cn.studyjams.s2.sj0132.bowenyan.myloveplayer.activities.QueryBrowserActivity;
...
public class AppWidget42 extends AppWidgetProvider {
    ...
    public void performUpdate(ApolloService service, int[] appWidgetIds) {
        ...
        if (playing) {
            views.setImageViewResource(R.id.four_by_two_control_play,
            		 (widget_type.equals(mContext.getResources().getString(R.string.widget_style_light))?R.mipmap.apollo_holo_light_pause:R.mipmap.apollo_holo_dark_pause));
            views.setContentDescription(R.id.four_by_two_albumart,
                service.getResources().getString(R.string.nowplaying));
        } else {
            views.setImageViewResource(R.id.four_by_two_control_play,
            		(widget_type.equals(mContext.getResources().getString(R.string.widget_style_light))?R.mipmap.apollo_holo_light_play:R.mipmap.apollo_holo_dark_play));
            views.setContentDescription(R.id.four_by_two_albumart,
        ...
        switch (service.getRepeatMode()) {
            case ApolloService.REPEAT_ALL:
                views.setImageViewResource(R.id.four_by_two_control_repeat,
                        R.mipmap.apollo_holo_light_repeat_all);
                break;
            case ApolloService.REPEAT_CURRENT:
                views.setImageViewResource(R.id.four_by_two_control_repeat,
                        R.mipmap.apollo_holo_light_repeat_one);
                break;
            default:
                views.setImageViewResource(R.id.four_by_two_control_repeat,
                		(widget_type.equals(mContext.getResources().getString(R.string.widget_style_light))?R.mipmap.apollo_holo_light_repeat_normal:R.mipmap.apollo_holo_dark_repeat_normal));
                break;
        }
        ...
        switch (service.getShuffleMode()) {
            case ApolloService.SHUFFLE_NONE:
                views.setImageViewResource(R.id.four_by_two_control_shuffle,
                		(widget_type.equals(mContext.getResources().getString(R.string.widget_style_light))?R.mipmap.apollo_holo_light_shuffle_normal:R.mipmap.apollo_holo_dark_shuffle_normal));
                break;
            case ApolloService.SHUFFLE_AUTO:
                views.setImageViewResource(R.id.four_by_two_control_shuffle,
                        R.mipmap.apollo_holo_light_shuffle_on);
                break;
            default:
                views.setImageViewResource(R.id.four_by_two_control_shuffle,
                        R.mipmap.apollo_holo_light_shuffle_on);
    ...
    private void linkButtons(Context context, RemoteViews views, boolean playerActive) {
        ...
        if (playerActive) {
            ...
            intent = new Intent(context, QueryBrowserActivity.class);
            pendingIntent = PendingIntent.getActivity(context, 0, intent, 0);
            views.setOnClickPendingIntent(R.id.four_by_two_albumart, pendingIntent);
            views.setOnClickPendingIntent(R.id.four_by_two_info, pendingIntent);
        }
