...
import cn.studyjams.s2.sj0132.bowenyan.myloveplayer.ui.fragments.AudioPlayerFragment;
import cn.studyjams.s2.sj0132.bowenyan.myloveplayer.ui.fragments.list.TracksFragment;

import static cn.studyjams.s2.sj0132.bowenyan.myloveplayer.Constants.INTENT_ADD_TO_PLAYLIST;
import static cn.studyjams.s2.sj0132.bowenyan.myloveplayer.Constants.INTENT_PLAYLIST_LIST;
import static cn.studyjams.s2.sj0132.bowenyan.myloveplayer.Constants.MIME_TYPE;
import static cn.studyjams.s2.sj0132.bowenyan.myloveplayer.Constants.PLAYLIST_QUEUE;
...
public class AudioPlayerHolder extends Activity implements ServiceConnection {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, SEARCH, 0, R.string.cd_search).setIcon(R.mipmap.apollo_holo_light_search)
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (MusicUtils.mService != null && MusicUtils.getCurrentAudioId() != -1) {
            if (MusicUtils.isFavorite(this, MusicUtils.getCurrentAudioId())) {
                favorite.setIcon(R.mipmap.apollo_holo_light_favorite_selected);
            } else {
                favorite.setIcon(R.mipmap.apollo_holo_light_favorite_normal);
                // Theme chooser
